...
public class BST {
    ...
    // private BSTNode temp = root;

    // private BSTNode temp = root;
    // private BSTNode insertHelper(int num, BSTNode head){
    ...
    //         System.out.println(head);
    //         head.left= insertHelper(num, head.left);
    //     }else{
    //         System.out.println(head);
    //         head.right= insertHelper(num, head.right);
    //     }
    //     return head;
    
    // }

    // public void insertc(int num) {
